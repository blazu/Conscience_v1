...
if(num <= 8){ //child male
	...
	temp = Origin[round(random_range(0, 28))];
	object_stats[obj_seq, 5] = temp;
	temp = Female_Name[round(random_range(0,98))];
	object_stats[obj_seq, 6] = temp;
...
temp = round(random_range(2, global.cash/2));
inventory[obj_seq, 1] = temp; 
inventory[obj_seq, 2] = temp;
inventory[obj_seq, 3] = temp;
