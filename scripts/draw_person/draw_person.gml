...
switch (object_stats[obj_seq, 2]){
	case "male":
		...
		which_object = "Male" + string(num) + "_obj";
		break;
	case "female":
		num = random_range(1, 5);
		which_object = "Female" + string(num) + "_obj";
}
